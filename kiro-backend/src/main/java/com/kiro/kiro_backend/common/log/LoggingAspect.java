...
package com.kiro.kiro_backend.common.log;
 ...
 * 2. Use INFO or above for com.kiro.kiro_backend.common.aspect.LoggingAspect
 */
@Aspect
@Component
@Log4j2
public class LoggingAspect {
  ...
  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.ApplicationService)")
  public void applicationServiceLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.DomainService)")
  public void domainServiceLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.PrimaryPort)")
  public void primaryPortLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.SecondaryPort)")
  public void secondaryPortLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.PrimaryMapper)")
  public void primaryMapperLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.SecondaryMapper)")
  public void secondaryMapperLayer() {
  }

  @Pointcut("@within(com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.DomainMapper)")
