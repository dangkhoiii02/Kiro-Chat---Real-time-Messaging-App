...
package com.kiro.kiro_backend.common.wire.websocket.primary;
...
import com.kiro.kiro_backend.common.websocket.infrastructure.primary.security.WebSocketAuthenticationManager;
...
public class WebSocketInterceptionSecurityConfiguration {
  ...
  public SecurityChannelInterceptorAdapter websocketSecurityInterceptor(KeycloakTokenVerifier tokenVerifier,
      JpaUserRepository userRepository, UserSynchronizeService userSynchronizeService) {
