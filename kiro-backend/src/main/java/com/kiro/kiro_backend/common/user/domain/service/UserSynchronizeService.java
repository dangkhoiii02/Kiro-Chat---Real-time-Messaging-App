...
package com.kiro.kiro_backend.common.user.domain.service;
...
import com.kiro.kiro_backend.common.user.domain.repository.AuthorityRepository;
...
public class UserSynchronizeService {
  ...
  private void ensureDefaultSettings(User savedUser) {
    if (savedUser == null || savedUser.getDbId() == null) {
      return;
    }

    userSettingRepository.getByUserId(savedUser.getDbId())
        .orElseGet(() -> userSettingRepository.createSetting(savedUser, new UserSetting(savedUser)));
  }
