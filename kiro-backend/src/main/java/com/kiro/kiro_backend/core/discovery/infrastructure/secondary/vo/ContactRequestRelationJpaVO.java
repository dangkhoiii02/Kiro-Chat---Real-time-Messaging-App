...
package com.kiro.kiro_backend.core.discovery.infrastructure.secondary.vo;
...
public record ContactRequestRelationJpaVO(Long id, Long requestUserId, Long receiverUserId) implements UserRelationJpaVO {
  ...
  @Override
  public com.kiro.kiro_backend.core.social.domain.vo.FriendshipStatus friendshipStatusWithUser(Long currentUserId) {
