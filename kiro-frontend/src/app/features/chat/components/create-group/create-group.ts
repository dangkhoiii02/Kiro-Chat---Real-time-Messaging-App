...
export class CreateGroup implements OnInit, OnDestroy {
  ...
  friendsLoading = this.service.friendsLoading;
  friendsError = this.service.friendsError;
  ...
  ngOnInit() {
    // Load all friends immediately on open
    ...
    this.searchControl.valueChanges
      ...
      .subscribe((query) => {
        ...
        this.service.loadFriends(query);
      });
  }
  ...
  isMemberSelected(friend: IFriend): boolean {
