...
package com.kiro.kiro_backend.common.migration.domain.service;

import java.util.ArrayList;
import java.util.List;

import com.kiro.kiro_backend.common.ddd.infrastructure.stereotype.DomainService;
import com.kiro.kiro_backend.common.migration.domain.aggregate.KeycloakUser;
import com.kiro.kiro_backend.common.migration.domain.aggregate.MigrationResult;
import com.kiro.kiro_backend.common.migration.domain.repository.KeycloakAdminClient;
import com.kiro.kiro_backend.common.migration.domain.repository.LegacyUserRepository;
import com.kiro.kiro_backend.common.migration.domain.vo.MigrationError;
import com.kiro.kiro_backend.common.migration.domain.vo.MigrationResultState;
import com.kiro.kiro_backend.common.migration.domain.vo.TotalMigrationFail;
import com.kiro.kiro_backend.common.migration.domain.vo.TotalMigrationUser;
