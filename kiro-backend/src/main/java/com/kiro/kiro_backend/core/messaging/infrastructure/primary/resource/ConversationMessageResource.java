...
package com.kiro.kiro_backend.core.messaging.infrastructure.primary.resource;

import java.util.Optional;
import java.util.UUID;

import com.kiro.kiro_backend.common.user.domain.vo.PublicId;
import com.kiro.kiro_backend.core.messaging.application.MessagingApplicationService;
...
import com.kiro.kiro_backend.core.messaging.domain.aggregate.MessageCursorQueryBuilder;
import com.kiro.kiro_backend.core.messaging.domain.vo.MessageLimit;
import com.kiro.kiro_backend.core.messaging.infrastructure.primary.mapper.RestConversationMessageMapper;
...
public class ConversationMessageResource {
  ...
  public ResponseEntity<?> markSeenMessage(@PathVariable("conversationId") UUID conversationId,
    ...
    try {
      ...
      log.warn("Ignore mark-as-seen failure for conversation {} and message {}",
          conversationId, restRequest.getLastSeenMessageId(), e);
    }
