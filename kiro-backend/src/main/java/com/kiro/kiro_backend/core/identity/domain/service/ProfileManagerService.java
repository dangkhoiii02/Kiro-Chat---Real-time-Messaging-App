...
package com.kiro.kiro_backend.core.identity.domain.service;

import java.util.Optional;

import com.kiro.kiro_backend.common.authentication.domain.CurrentUser;
import com.kiro.kiro_backend.common.authentication.domain.Username;
...
import com.kiro.kiro_backend.common.user.domain.vo.UserImageUrl;
import com.kiro.kiro_backend.core.discovery.domain.repository.UserConnectionResolver;
import com.kiro.kiro_backend.core.identity.domain.aggregate.PersonalProfile;
import com.kiro.kiro_backend.core.identity.domain.aggregate.PersonalProfileChanges;
import com.kiro.kiro_backend.core.identity.domain.aggregate.ProfileSettingChanges;
import com.kiro.kiro_backend.core.identity.domain.aggregate.PublicProfile;
import com.kiro.kiro_backend.core.identity.domain.aggregate.UserSetting;
import com.kiro.kiro_backend.core.identity.domain.repository.ProfileRepository;
import com.kiro.kiro_backend.core.identity.domain.repository.UserSettingRepository;
import com.kiro.kiro_backend.core.identity.domain.vo.ProfilePublicId;
...
public class ProfileManagerService {
  ...
  public UserSetting readProfileSettings() {
    User currentUser = userRepository.getByPrincipal(principal)
        .or(() -> userRepository.getByEmail(principal.getUserEmail()))
        .orElseThrow(() -> new EntityNotFoundException());

    return userSettingRepository.getByUserId(currentUser.getDbId())
        .orElseGet(() -> userSettingRepository.createSetting(currentUser, new UserSetting(currentUser)));
  }
